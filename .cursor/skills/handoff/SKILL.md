...
**Output locale (this repo):** [`.cursor/plans/_shared/output-locale.md`](../../plans/_shared/output-locale.md) — handoff body for the user **English** when continuing product work; code paths in English.
